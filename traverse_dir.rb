...
puts "<div id=\"infooverlay\"><div id=\"infobox\"><div id=\"infoclose\">[close]</div><h2>About RollerCaster</h2><p>RollerCaster started as a proof of concept by Mattias Schlenker that it is easily possible to stream media from a local NAS to your Chromecast. Get the code and the documentation at <a href=\"https://github.com/mschlenker/RollerCaster\" target=\"blank\">github.com/mschlenker/RollerCaster</a>. Contact my be Email or send my a beer via PayPal: <a href=\"mailto:ms@mattiasschlenker.de\">ms@mattiasschlenker.de</a>. If you are a vendor of NAS devices you might contact me to buy a few hours of consulting to include RollerCaster to your devices.</p></h2></div></div>"
