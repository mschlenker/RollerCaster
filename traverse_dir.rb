...
puts "</div>"
puts "<div id=\"erroroverlay\"><div id=\"errorbox\"><h2>Could not initialize</h2><p>RollerCaster could not be initialized. This means that either you are not using Chrome or Chromium or the Chromecast add on is missing.</p></h2></div></div>"
...
puts "} catch(e) {"
puts "  document.getElementById(\"erroroverlay\").style.display = \"block\";"
puts "}"
puts "</script>"
puts "</body></html>"
